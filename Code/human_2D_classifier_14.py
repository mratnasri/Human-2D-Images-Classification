...
def train_model(datax, datay, valx, valy):
    model = model_config()
    # fit model
    history = model.fit(datax, datay, epochs=30, batch_size=100,
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model14_graph.png')

model.save('../Models/human_2D_model14.h5')
print("saved")
...
#plt.savefig('../../Outputs/model14_confusionMatrix.png')
plt.show()
